...
def test_check_duplicates():
    target_df = pd.read_csv("/Users/yvonnek/anaconda3/pkgs/data/employee_dept_no_copy_tgt.csv", sep=",")
...
def test_dat_completeness():
    target_df = pd.read_csv("/Users/yvonnek/anaconda3/pkgs/data/employee_dept_no_copy_tgt.csv")
